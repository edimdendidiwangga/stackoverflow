<template>
<div class="navbar">
  <nav class="ui menu orange inverted navbar page grid" style="margin-bottom: 0px">
    <a href="" class="brand item"><h2><i class="stack overflow icon"></i>{{ logo }}</h2></a>
    <div class="right menu" v-if="login">
      <div class="item"><button class="ui green button" id="btnLogin">Sign in</button></div>
      <div class="item"><button class="ui teal button" id="btnSignup">Sign up</button></div>
      <div class="item"><button class="ui facebook button" v-on:click="loginFB">
